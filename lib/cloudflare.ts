...
export function getZoneIdByBaseDomain(baseDomain: string): string {
  switch (baseDomain) {
    ...
    case "lcp7.com.br":
      return env("CLOUDFLARE_ZONE_ID_LCP7");
    case "lcp8.com.br":
      return env("CLOUDFLARE_ZONE_ID_LCP8");
    case "lcp9.com.br":
      return env("CLOUDFLARE_ZONE_ID_LCP9");
    case "acm1.com.br":
      return env("CLOUDFLARE_ZONE_ID_ACM1");
    case "acm2.com.br":
      return env("CLOUDFLARE_ZONE_ID_ACM2");
    case "acm3.com.br":
      return env("CLOUDFLARE_ZONE_ID_ACM3");
    case "acm4.com.br":
      return env("CLOUDFLARE_ZONE_ID_ACM4");
    case "acm5.com.br":
